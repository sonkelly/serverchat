 ...
 * @author mcb
 */
public class GetTopFileJSON implements IMessageProtocol {

    private final Logger mLog = LoggerContext.getLoggerFactory().getLogger(GetTopFileJSON.class);
    ...
    public Object encode(IResponseMessage aResponseMessage) throws ServerException {
        try {
            ...
            GetTopFileResponse res = (GetTopFileResponse) aResponseMessage; 
