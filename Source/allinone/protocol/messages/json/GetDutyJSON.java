 ...
 * @author mcb
 */
public class GetDutyJSON implements IMessageProtocol {

    private final Logger mLog = LoggerContext.getLoggerFactory().getLogger(GetDutyJSON.class);
...
//        }
    ...
    public Object encode(IResponseMessage aResponseMessage) throws ServerException {
        try {
            ...
            GetDutyResponse res = (GetDutyResponse) aResponseMessage; 
