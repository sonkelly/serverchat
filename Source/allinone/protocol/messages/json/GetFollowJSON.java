 ...
 * @author mcb
 */
public class GetFollowJSON implements IMessageProtocol {

    private final Logger mLog = LoggerContext.getLoggerFactory().getLogger(GetFollowJSON.class);
    ...
    public Object encode(IResponseMessage aResponseMessage) throws ServerException {
        try {
            ...
            GetFollowResponse res = (GetFollowResponse) aResponseMessage; 
