 ...
 * @author mcb
 */
public class EnterChatRoomJSON implements IMessageProtocol {

    private final Logger mLog = LoggerContext.getLoggerFactory().getLogger(EnterChatRoomJSON.class);
    ...
    public Object encode(IResponseMessage aResponseMessage) throws ServerException {
        try {
            ...
            EnterChatRoomResponse res = (EnterChatRoomResponse) aResponseMessage; 
