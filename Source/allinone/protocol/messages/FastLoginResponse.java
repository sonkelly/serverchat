...
public class FastLoginResponse extends AbstractResponseMessage {
    ...
    public void setSuccess(int aCode, long aUid, long mn,long rm, Date time, String _avatar, String _viewname) {
        mCode = aCode;
        mUid = aUid;
        money = mn;
        realmoney = rm;
