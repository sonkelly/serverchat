 ...
 * @author mac
 */
public class LogchatxdDB {
    private static final Logger mLog = LoggerContext.getLoggerFactory()
            .getLogger(LogchatxdDB.class);
    
    public ArrayList<TXChat> getLogChatXd(String limit) throws Exception {
        ArrayList<TXChat> res = new ArrayList<TXChat>();
        String query = "SELECT * FROM  `logchatxd` ORDER BY  `id` DESC limit " + limit;
    ...
    public void addLogChat(long uid, String _viewname, String _msg) throws Exception {
        boolean res = false;
        String query = "INSERT INTO logchatxd (uid,viewname,message,createdtime) VALUES (? , ?, ?,?)";
